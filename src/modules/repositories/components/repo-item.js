...
const SRepoItem = props => {
  ...
  return (
    <Div className="rounded d-flex flex-column pt-2 pb-4 px-3 mb-2">
      <div className="d-flex flex-row align-items-center justify-content-between">
        ...
        <strong>
          <i
            ...
            className="material-icons text-blue-900 delete-btn"
          >
            close
          </i>
        </strong>
      ...
      <div className="d-flex flex-row align-items-center justify-content-between w-100 pt-2">
        <div className="d-flex flex-row align-items-center">
          ...
          <LazyLoadImage
            ...
            src={owner.avatarUrl}
            className="img-fluid img-shape rounded-circle"
          />
      ...
      <p className="font-weight-bold pt-3">{description}</p>
      <div className="d-flex flex-row align-items-center">
        <div className="d-flex flex-row">
          <span className="toggle-states pr-2">
          ...
          <div className="custom-control custom-switch">
            <input
              ...
              id="customSwitch1"
              readOnly={true}
              checked={isCheckedAsPrivate()}
            />
            <label
              className="custom-control-label toggle-states"
        ...
        <div className="d-flex flex-row align-items-center justify-content-start pl-3">
          ...
          <i
            className="material-icons text-gold"
            data-toggle="tooltip"
            data-placement="top"
            title="Stargazers"
          >
        ...
        <div className="d-flex flex-row align-items-center justify-content-start pl-3">
          ...
          <i
            className="material-icons text-900"
            data-toggle="tooltip"
            data-placement="top"
            title="Forks"
          >
